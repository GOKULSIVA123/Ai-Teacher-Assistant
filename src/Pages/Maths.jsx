...
import mathsQuestions from "./maths.json";
...
function Maths() {
  ...
  const questions = mathsQuestions.questions;
  ...
  function handleAnswer(choice) {
    ...
    setResult((prev) => ({
      score: isCorrect ? prev.score + mathsQuestions.perQuestionScore : prev.score,
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center bg-blue-300 p-4">
      {!showResult ? (
        <div className="w-full max-w-xl bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-xl font-semibold mb-4">
            Maths Quiz ({activeQuestion + 1}/{questions.length})
          </h2>
